...
public class UserDao {
    ...
    private static final String QUERY_BY_USERNAME_SQL = "SELECT user_id, user_name, credits" +
    ...
    public void updateLoginInfo(User user) {
        ...
        jdbcTemplate.update(UPDATE_LOGIN_INFO_SQL, new Object[]{user.getLastVisit().toString(), user.getLastIp(),
